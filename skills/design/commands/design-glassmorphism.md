---
description: Apply the Glassmorphism design system — loads the glassmorphism skill and reads the project's design tokens from specs/frontend/02-design.md
---

Load the `glassmorphism` design skill first, then READ `specs/frontend/02-design.md` at the project root:
