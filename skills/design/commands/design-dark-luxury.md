---
description: Apply the Dark Luxury design system — loads the dark-luxury skill and reads the project's design tokens from specs/frontend/02-design.md
---

Load the `dark-luxury` design skill first, then READ `specs/frontend/02-design.md` at the project root:
