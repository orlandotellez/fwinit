---
description: Apply the Minimal Light design system — loads the minimal-light skill and reads the project's design tokens from specs/frontend/02-design.md
---

Load the `minimal-light` design skill first, then READ `specs/frontend/02-design.md` at the project root:
